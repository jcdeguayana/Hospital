<%@ Page Language="C#" AutoEventWireup="true" Inherits="Vistas.MainPageMedico" Codebehind="MainPageMedico.aspx.cs" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
   <meta charset="UTF-8" />
   <meta name="viewport" content="width=device-width, initial-scale=1.0" />
   <title>Hospital April - Portal Médicos</title>
   <style>
       /* Estilos generales */
       html, body, form {
           margin: 0;
   ...
   <form id="form1" runat="server">
       ...
       <div class="main-content">
           ...
           <div class="options">
               ...
               <asp:HyperLink NavigateUrl="MisTurnos.aspx" CssClass="link" runat="server">
                   <div class="option">
                       <asp:Image ID="imgTurno" runat="server" ImageUrl="~/images/icono_turno.png" AlternateText="Mis Turnos" />
                       Mis Turnos
                   </div>
               </asp:HyperLink>
               
               <asp:HyperLink NavigateUrl="MisDatos.aspx" CssClass="link center-option" runat="server">
                   <div class="option">
                       <asp:Image ID="imgInformes" runat="server" ImageUrl="~/images/icono_informes.png" AlternateText="Mis Datos" />
                       Mis Datos
                   </div>
               </asp:HyperLink>
           </div>
